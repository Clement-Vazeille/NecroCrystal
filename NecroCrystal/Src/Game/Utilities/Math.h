...
public:
	...
	static float Distance(sf::Vector2f direction,sf::Vector2i& windowDimensions);
	static float DistanceLat(sf::Vector2f direction,sf::Vector2i& windowDimensions); //c'est une distance qui boost grandement l'axe y et réduit l'axe x
